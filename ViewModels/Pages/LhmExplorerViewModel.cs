...
{
    public partial class LhmGroupedHardware : ObservableObject
    {
        public string HardwareName { get; set; } = string.Empty;
        public HardwareType HardwareType { get; set; }
        public List<LhmGroupedSensor> SensorGroups { get; set; } = [];

        [ObservableProperty] private bool _isExpanded;
    }

    public class LhmGroupedSensor
    {
        public string CategoryName { get; set; } = "Sensors";
        public List<SensorNode> Sensors { get; set; } = [];
    }

    public partial class LhmExplorerViewModel(UiService uiService, AquilaService aquilaService) : ObservableObject
    {
        ...
        private List<LhmGroupedHardware> _groupedHardware = [];

        [ObservableProperty]
        [NotifyPropertyChangedFor(nameof(FilteredHardware))]
        private string _searchText = string.Empty;

        public IEnumerable<LhmGroupedHardware> FilteredHardware
        {
            get
            {
        ...
        public Task InitializeAsync()
        {
            ...
            var list = new List<LhmGroupedHardware>();
        ...
        private static void AddHardwareRecursive(List<LhmGroupedHardware> target, IHardware hardware, string? parentPath)
        {
            ...
            var groups = hardware.Sensors
                ...
                .Select(group => new LhmGroupedSensor
                {
            ...
            target.Add(new LhmGroupedHardware
            {
